				...
				<div class="container">
						<div class="auth-main auth-row auth-col-one">
							...
							<div class="auth-bottom auth-row auth-reset">
								<div class="tgauth">
								<p>Please keep your login password properly</p>	
								</div>
							</div>
						</div>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										<p class="text-right">
										<button class="btn btn-flat btn-brand-accent waves-attach waves-effect" data-dismiss="modal" type="button">Oh I see</button>
                                      </p>
									</div>
								</div>
							</div>
